...
SIMPLE_JWT = {
    ...
    'TOKEN_OBTAIN_SERIALIZER': 'medical_api.apps.accounts.serializers.CustomTokenObtainPairSerializer',
    'TOKEN_REFRESH_SERIALIZER': 'medical_api.apps.accounts.serializers.CustomTokenRefreshSerializer',
